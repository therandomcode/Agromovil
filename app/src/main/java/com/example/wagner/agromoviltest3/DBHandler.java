...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_TRANSPORTERS + "("
                ...
                + KEY_CARMAKE + " TEXT," + KEY_IMGID + " TEXT," + KEY_TIMES + " TEXT" + ")";
...
// Creating tables again
    ...
    public void addTransporter(Transporter transporter) {
        ...
        values.put(KEY_CARMAKE, transporter.getCarMake()); // Transporter Car Make
        values.put(KEY_IMGID, transporter.getImgid()); // Transporter imgid
...
// Inserting Row
    ...
    public Transporter getTransporter(String lastname) {
        ...
        Cursor cursor = db.query(TABLE_TRANSPORTERS, new String[]{KEY_FIRSTNAME,
                        KEY_LASTNAME, KEY_ADDRESS, KEY_CARMAKE, KEY_IMGID, KEY_TIMES},
                KEY_LASTNAME + "=?", new String[]{String.valueOf(lastname)},
                null, null, null, null);
        if (cursor != null)
            cursor.moveToFirst();
        Transporter contact = new Transporter(cursor.getString(0),
                ...
                string_to_hash(cursor.getString(5)));
        db.close();
        return contact;
    }
    ...
    public List<Transporter> getAllTransporters() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                transporter.setImgid(Integer.valueOf(cursor.getString(4)));
                transporter.setHash(string_to_hash(cursor.getString(5)));
